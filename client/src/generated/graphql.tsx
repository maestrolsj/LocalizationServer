...
export type HomePage_ProjectsQuery = { __typename?: 'Query' } & {
    projects: Array<{ __typename?: 'Project' } & Pick<Project, 'id' | 'key' | 'name' | 'description'>>;
};
...
export type KeyFormModal_KeyQuery = { __typename?: 'Query' } & {
    key: { __typename?: 'Key' } & Pick<Key, 'id' | 'name' | 'plural'>;
};
...
export type KeyFormModal_UpsertKeyMutation = { __typename?: 'Mutation' } & {
    upsertKey?: Maybe<{ __typename?: 'Key' } & Pick<Key, 'id' | 'name' | 'plural'>>;
};
...
export type LocaleFormModal_LocaleQuery = { __typename?: 'Query' } & {
    locale: { __typename?: 'Locale' } & Pick<Locale, 'id' | 'name' | 'code' | 'nativeName'>;
};
...
export type LocaleFormModal_UpsertLocaleMutation = { __typename?: 'Mutation' } & {
    upsertLocale?: Maybe<{ __typename?: 'Locale' } & Pick<Locale, 'id' | 'name' | 'nativeName' | 'code'>>;
};
...
export type ProjectFormModal_ProjectQuery = { __typename?: 'Query' } & {
    project: { __typename?: 'Project' } & Pick<Project, 'id' | 'key' | 'name' | 'description'>;
};
...
export type ProjectFormModal_UpsertProjectMutation = { __typename?: 'Mutation' } & {
    upsertProject?: Maybe<{ __typename?: 'Project' } & Pick<Project, 'id' | 'key' | 'name' | 'description'>>;
};
...
export type Screen_ProjectQuery = { __typename?: 'Query' } & {
    project: { __typename?: 'Project' } & Pick<Project, 'id' | 'key' | 'name' | 'description'> & {
            screens: Array<{ __typename?: 'Screen' } & Pick<Screen, 'id' | 'name'>>;
            locales: Array<{ __typename?: 'Locale' } & Pick<Locale, 'id' | 'name'>>;
        };
};
...
export type ScreenFormModal_ScreenQuery = { __typename?: 'Query' } & {
    screen: { __typename?: 'Screen' } & Pick<Screen, 'id' | 'key' | 'name' | 'description'>;
};
...
export type ScreenFormModal_UpsertScreenMutation = { __typename?: 'Mutation' } & {
    upsertScreen?: Maybe<{ __typename?: 'Project' } & Pick<Project, 'id' | 'key' | 'name' | 'description'>>;
};
...
export type TranslatePage_ProjectQuery = { __typename?: 'Query' } & {
    project: { __typename?: 'Project' } & {
        locales: Array<{ __typename?: 'Locale' } & Pick<Locale, 'id' | 'name' | 'nativeName' | 'code'>>;
    };
};
...
export type TranslatePage_ScreenQuery = { __typename?: 'Query' } & {
    screen: { __typename?: 'Screen' } & Pick<Screen, 'id' | 'name' | 'description'> & {
            keys: Array<
                { __typename?: 'Key' } & Pick<Key, 'id' | 'name' | 'plural'> & {
                        translations: Array<
                            { __typename?: 'Translation' } & Pick<Translation, 'id' | 'value'> & {
                                    locale: { __typename?: 'Locale' } & Pick<Locale, 'id'>;
                                }
                        >;
                    }
            >;
...
export type TranslatePage_DeleteKeyMutation = { __typename?: 'Mutation' } & Pick<Mutation, 'deleteKey'>;

export type TranslationFormModal_TranslationQueryVariables = Exact<{
    id: Scalars['ID'];
}>;

export type TranslationFormModal_TranslationQuery = { __typename?: 'Query' } & {
    translation: { __typename?: 'Translation' } & Pick<Translation, 'id' | 'value'>;
};
...
export type TranslationFormModal_UpsertTranslationMutation = { __typename?: 'Mutation' } & {
    upsertTranslation?: Maybe<{ __typename?: 'Translation' } & Pick<Translation, 'id' | 'value'>>;
};
...
export type LoginPage_LoginQuery = { __typename?: 'Query' } & {
    login?: Maybe<
        { __typename?: 'AuthenticationPayload' } & Pick<AuthenticationPayload, 'accessToken'> & {
...
export type RedefinePasswordPage_ResetPasswordMutation = { __typename?: 'Mutation' } & {
    resetPassword?: Maybe<
        { __typename?: 'AuthenticationPayload' } & Pick<AuthenticationPayload, 'accessToken'> & {
                user: { __typename?: 'User' } & Pick<
                    User,
...
export type RegisterPage_UpsertUserMutation = { __typename?: 'Mutation' } & {
    upsertUser?: Maybe<
        { __typename?: 'User' } & Pick<User, 'id' | 'email' | 'firstName' | 'lastName' | 'createdAt' | 'updatedAt'>
    >;
};
